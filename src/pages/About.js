    ...
    <MDBContainer>
      ...
      <div class="row mb-5">
        <div class="col-md-4 mb-3">
          <img src={logoR} alt='Sophia Masone standing in bedroom with peace sign up' className="about-img"/>
        </div>
      ...
      <div class="row mb-5">
        <div class="col-md-4 mb-3">
          <img src= {logoL} alt='Lainey Wright standing behind castle' className="about-img"/>
        </div>
        <div class="col-md-8 mb-3">
          <h3>Lainey Wright</h3>
      ...
      <div class="row mb-5">
        <div class="col-md-4 mb-3">
          <img src={logoA} alt='Andrew Lombardo on a subway' className="about-img"/>
        </div>
        <div class="col-md-8 mb-3">
      ...
      <div class="row mb-5">
        <div class="col-md-4 mb-3">
          <img src={logoC} alt='Christopher Castillo in nature' className="about-img"/>
        </div>
        <div class="col-md-8 mb-3">
